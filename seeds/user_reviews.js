  ...
  return knex('user_reviews').del()
    .then(function () {
      ...
      return knex('user_reviews').insert([
        ...
        {id: 2, user_id: '4', review: 'service was ok. Could do better!', rating, '2', poster_id: '4'},
        {id: 3, user_id: '1', review: 'service was amazing!', rating, '4', poster_id: '2'},
        {id: 4, user_id: '6', review: 'Ok but forgot to feed my cat, though.', rating, '1', poster_id: '2'},
