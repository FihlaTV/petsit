  ...
  return knex('pets').del()
    .then(function () {
      ...
      return knex('pets').insert([
        ...
        {owner_id: 7, pet_name: 'Keefer', species: 'Golden Beast', age: 9, bio: 'Keefer is a fit and lean 84 lb golden with a complex personality. He is highly food driven and appreciates the finer things in life but is not above any form of sustenance', temperament: 'Snoozy', notes: 'Keefer knows no shame so dont even try', pic_url:'http://i.imgur.com/MOO3S6H.jpg'},
        {owner_id: 1, pet_name: 'Holly', species: 'Corgi', age: 13, bio: 'She makes for a great class mascot', temperament: 'lazy', notes: 'Loves to be pet', pic_url:'http://i.imgur.com/HfLJVqp.jpg'}
      ]);
    });
};
