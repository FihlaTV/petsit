  ...
  return knex('requests').del()
    .then(function () {
      ...
      return knex('requests').insert([
        ...
        {poster_id: '4', pet_id: '3', start_date:"2022-10-01", end_date:"2023-10-03", notes: "Keep my pet for a year please"},
        {poster_id: '5', pet_id: '3', start_date:"2017-12-01", end_date:"2018-01-01", notes: "Fido is looking for xmas & new years hosts"},
